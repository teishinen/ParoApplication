...
public class RecordViewModel extends AndroidViewModel{
    ...
    public String getProblemBehaviorsByPatientName(String patientName,String item) throws ExecutionException, InterruptedException {
        return recordRepository.getProblemBehaviorsByPatientName(patientName,item);
    }
    public String getPatientRecordTextView(String startId, String patientName, String item, String time) throws ExecutionException, InterruptedException {
        return recordRepository.getPatientRecordTextView(startId,patientName,item,time);
    }

    public String getStaffRecordTextView(String startId,String staffName, String item, String time) throws ExecutionException, InterruptedException {
        return recordRepository.getStaffRecordTextView(startId,staffName,item,time);
    }
    public static Record findPatientRecordByCoordinate(String startId, String time, String patientName, String item ) throws ExecutionException, InterruptedException {
        return recordRepository.findPatientRecordByCoordinate(startId,time,patientName,item);
    }
    public static Record findStaffRecordByCoordinate(String startId,String time, String patientName, String item ) throws ExecutionException, InterruptedException {
        return recordRepository.findStaffRecordByCoordinate(startId,time,patientName,item);
    }
