...
public class PatientAdapter extends ListAdapter<Patient, PatientAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectedPatientName = patient.getPatientName();
                selectedPatientAge = patient.getPatientAge();
                selectedPatientSex = patient.getPatientSex();
                NavController controller = Navigation.findNavController(v);
                controller.navigate(R.id.action_ledgerFragment_to_patientFragment);
            }
        });
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        try {
            ...
            String problemBehaviors = recordViewModel.getProblemBehaviorsByPatientName(patientName,item);
            holder.textViewProblemBehaviors.setText(problemBehaviors);
        } catch (ExecutionException | InterruptedException e) {
            e.printStackTrace();
        }
